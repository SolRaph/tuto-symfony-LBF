...
class __TwigTemplate_63db68cab9f955100a2bf23defa0e055 extends Template
{
    private $source;
    private $macros = [];
...
<p>
    ...
    Il semblerait que votre paiement est échoué pour votre commande n° <strong>";
        ...
        echo "</strong>
    Une confirmation par mail vient de vous être envoyé à l'adresse : <strong>";
        // line 10
    ...
    <a href=\"";
        ...
        echo "\"class='btn btn-info mt-5'>Réessayer le paiement </a>
...
";
    ...
    {
        return array (  108 => 13,  102 => 10,  98 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<p>
    ...
    Il semblerait que votre paiement est échoué pour votre commande n° <strong>{{order.reference}}</strong>
    Une confirmation par mail vient de vous être envoyé à l'adresse : <strong>{{order.user.email}}</strong>
    <br>

    <a href=\"{{path('app_order')}}\"class='btn btn-info mt-5'>Réessayer le paiement </a>

</p>
{% endblock %}
", "order_cancel/index.html.twig", "/var/www/html/laboutiquefrancaise/templates/order_cancel/index.html.twig");
    }
}
