...
class __TwigTemplate_6a06a8320ce3a812d695d982521bcb6e extends Template
{
    private $source;
    private $macros = [];
...
<p>
    ...
    ";
        // line 20
        echo $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 20, $this->source); })()));
        echo "
";
    ...
    {
        return array (  124 => 20,  116 => 15,  111 => 13,  107 => 12,  102 => 10,  98 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<p>
    ...
    Une confirmation vient de vous être envoyée par mail à l'adresse : <strong>{{order.user.email}}</strong> 
    <hr>
    Votre commande sera livrée par <strong>{{order.carrierName}}</strong> à l'adresse suivante :<br/>
    <strong>{{order.delivery | raw}}</strong>
    <hr>
    Pour suivre votre commande, rendez vous dans votre <a href=\"{{path('app_account')}}\">compte</a>
    ...
    {{ dump(order) }}
{% endblock %}
", "order_validate/index.html.twig", "/var/www/html/laboutiquefrancaise/templates/order_validate/index.html.twig");
    }
}
