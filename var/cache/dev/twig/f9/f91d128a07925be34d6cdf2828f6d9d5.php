...
class __TwigTemplate_684cfc260be0b65b431ba83e074a595c extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
    <div class=\"block-small\">
        <h2 class='text-center my-5'>Page introuvable</h2>
            <p class='text-center my-5'>Il semble que vous vous soyez égarer dans le néant d'internet, veuillez utiliser une URL existante ! </p>
            <a href=\"{{path('app_home')}}\" class='btn btn-info w-100 my-5'>Revenir à l'accueil du site </a>
    </div>
{% endblock %}
", "@Twig/Exception/error.html.twig", "/var/www/html/laboutiquefrancaise/templates/bundles/TwigBundle/Exception/error.html.twig");
    }
}
