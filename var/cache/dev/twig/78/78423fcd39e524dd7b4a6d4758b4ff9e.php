...
class __TwigTemplate_de38ca6be82c870081c76a178c4e770c extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        // line 14
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 14, $this->source); })()), "prix", [], "any", false, false, false, 14) / 100), "2"), "html", null, true);
        echo " €</span>
            <hr>
            <p>";
        // line 16
...
{% block content %}
    ...
    <div class=\"row\">
        ...
        <div class=\"col-md-7 my-auto\">
            ...
            <span class=\"product-page-prix\">{{(product.prix / 100) |number_format('2')}} €</span>
            <hr>
...
{% endblock %}", "products/show.html.twig", "/var/www/html/laboutiquefrancaise/templates/products/show.html.twig");
    }
}
