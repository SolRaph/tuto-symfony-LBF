...
class __TwigTemplate_76e802799d4f94f01580712ce9fcdd96 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        // line 14
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "prix", [], "any", false, false, false, 14) / 100), "2"), "html", null, true);
        echo " €</span>
            <hr>
            <p>";
        // line 16
        ...
        echo "</p>
            <a href=\"";
        // line 17
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("add_to_cart", ["id" => twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "id", [], "any", false, false, false, 17)]), "html", null, true);
...
";
    ...
    {
        return array (  138 => 31,  123 => 29,  121 => 28,  118 => 27,  101 => 26,  89 => 17,  85 => 16,  80 => 14,  76 => 13,  72 => 12,  64 => 9,  59 => 6,  55 => 5,  47 => 3,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "products/show.html.twig", "/var/www/html/laboutiquefrancaise/templates/products/show.html.twig");
    }
}
